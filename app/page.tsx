          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div className="text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <a href={`${pathname}/Groups`} className="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">👉 兴趣社团 👈</a>
                <a href={`${pathname}/AboutUs`} className="text-sm/6 font-semibold text-gray-600">了解更多 <span aria-hidden="true">→</span></a>
              </div>
            </div>
          </div>
